...
public class  Main
{
    public static void  main(String[] args, int apelku, Object manggaku)
    {
        System.out.println( "Hello World!" );
        Keranjang keranjangKu = new Keranjang();
        Mangga manggaKu = new Mangga(manggaku);
        Apel apelKu = new Apel(apelku);
        System.out.println("\n========== TESTCASE #1 ==========");
